			...
			<div class="container">
				<div class="row-fluid">
					<div class="span4">
						...
						<a href="http://www.facebook.com/walfdreams"><i class="fwicon-facebook icon-2x"></i></a>
						<a href="http://www.twitter.com/walfdreams"><i class="fwicon-twitter icon-2x"></i></a>
						<a href="mailto:hello@walfdreams.com"><i class="fwicon-envelope icon-2x"></i></a>
					</div>
					<div class="span4">
						<center>
